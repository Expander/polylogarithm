...
double algorithm_490(double X)
{
   ...
   const double C[30] = {
      36, 576, 3600, 14400, 44100, 112896, 254016, 518400, 980100, 1742400,
      2944656, 4769856, 7452900, 11289600, 16646400, 23970816, 33802596,
      46785600, 63680400, 85377600, 112911876, 147476736, 190440000, 243360000,
...
L100:
   X0 = 12.5951703698450184;
   Y = X/X0 - 1;
   Z = 1/11.5951703698450184;
   W = Y*Z;
   C1 = (3*X0 - 2)/6;
   C2 = ((11*X0 - 15)*X0 + 6)/24;
