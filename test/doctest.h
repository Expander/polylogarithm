...
struct DOCTEST_INTERFACE Approx
{
    ...
    explicit Approx(const T& value,
                    typename detail::types::enable_if<std::is_constructible<long double, T>::value>::type* =
                            static_cast<T*>(nullptr)) {
        *this = static_cast<long double>(value);
    }
#endif // DOCTEST_CONFIG_INCLUDE_TYPE_TRAITS
...
#ifdef DOCTEST_CONFIG_INCLUDE_TYPE_TRAITS
    template <typename T>
    typename std::enable_if<std::is_constructible<long double, T>::value, Approx&>::type epsilon(
            const T& newEpsilon) {
...
#ifdef DOCTEST_CONFIG_INCLUDE_TYPE_TRAITS
    template <typename T>
    typename std::enable_if<std::is_constructible<long double, T>::value, Approx&>::type scale(
            const T& newScale) {
    ...
    // clang-format off
    DOCTEST_INTERFACE friend bool operator==(long double lhs, const Approx & rhs);
    DOCTEST_INTERFACE friend bool operator==(const Approx & lhs, long double rhs);
    DOCTEST_INTERFACE friend bool operator!=(long double lhs, const Approx & rhs);
    DOCTEST_INTERFACE friend bool operator!=(const Approx & lhs, long double rhs);
    DOCTEST_INTERFACE friend bool operator<=(long double lhs, const Approx & rhs);
    DOCTEST_INTERFACE friend bool operator<=(const Approx & lhs, long double rhs);
...
#define DOCTEST_APPROX_PREFIX \
    template <typename T> friend typename std::enable_if<std::is_constructible<long double, T>::value, bool>::type

    DOCTEST_APPROX_PREFIX operator==(const T& lhs, const Approx& rhs) { return operator==(static_cast<long double>(lhs), rhs); }
    DOCTEST_APPROX_PREFIX operator==(const Approx& lhs, const T& rhs) { return operator==(rhs, lhs); }
    DOCTEST_APPROX_PREFIX operator!=(const T& lhs, const Approx& rhs) { return !operator==(lhs, rhs); }
    DOCTEST_APPROX_PREFIX operator!=(const Approx& lhs, const T& rhs) { return !operator==(rhs, lhs); }
    DOCTEST_APPROX_PREFIX operator<=(const T& lhs, const Approx& rhs) { return static_cast<long double>(lhs) < rhs.m_value || lhs == rhs; }
    DOCTEST_APPROX_PREFIX operator<=(const Approx& lhs, const T& rhs) { return lhs.m_value < static_cast<long double>(rhs) || lhs == rhs; }
    DOCTEST_APPROX_PREFIX operator>=(const T& lhs, const Approx& rhs) { return static_cast<long double>(lhs) > rhs.m_value || lhs == rhs; }
    DOCTEST_APPROX_PREFIX operator>=(const Approx& lhs, const T& rhs) { return lhs.m_value > static_cast<long double>(rhs) || lhs == rhs; }
    DOCTEST_APPROX_PREFIX operator< (const T& lhs, const Approx& rhs) { return static_cast<long double>(lhs) < rhs.m_value && lhs != rhs; }
    DOCTEST_APPROX_PREFIX operator< (const Approx& lhs, const T& rhs) { return lhs.m_value < static_cast<long double>(rhs) && lhs != rhs; }
...
Approx::Approx(long double value)
        : m_epsilon(static_cast<long double>(std::numeric_limits<float>::epsilon()) * 100)
        , m_scale(1.0)
        , m_value(value) {}

Approx Approx::operator()(long double value) const {
    Approx approx(value);
...
Approx& Approx::epsilon(long double newEpsilon) {
    m_epsilon = newEpsilon;
    return *this;
}
Approx& Approx::scale(long double newScale) {
    m_scale = newScale;
    return *this;
}

bool operator==(long double lhs, const Approx& rhs) {
    // Thanks to Richard Harris for his help refining this formula
    return std::fabs(lhs - rhs.m_value) <
           rhs.m_epsilon * (rhs.m_scale + std::max<long double>(std::fabs(lhs), std::fabs(rhs.m_value)));
}
bool operator==(const Approx& lhs, long double rhs) { return operator==(rhs, lhs); }
bool operator!=(long double lhs, const Approx& rhs) { return !operator==(lhs, rhs); }
bool operator!=(const Approx& lhs, long double rhs) { return !operator==(rhs, lhs); }
bool operator<=(long double lhs, const Approx& rhs) { return lhs < rhs.m_value || lhs == rhs; }
bool operator<=(const Approx& lhs, long double rhs) { return lhs.m_value < rhs || lhs == rhs; }
bool operator>=(long double lhs, const Approx& rhs) { return lhs > rhs.m_value || lhs == rhs; }
bool operator>=(const Approx& lhs, long double rhs) { return lhs.m_value > rhs || lhs == rhs; }
bool operator<(long double lhs, const Approx& rhs) { return lhs < rhs.m_value && lhs != rhs; }
bool operator<(const Approx& lhs, long double rhs) { return lhs.m_value < rhs && lhs != rhs; }
