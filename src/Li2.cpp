...
double Li2(double x) noexcept
{
   ...
   const double P[] = {
      1.0000000000000000022e+0,
     -2.9452146247536479695e+0,
      3.2701922066496180781e+0,
     -1.6849523650728013997e+0,
      3.9511504975230785304e-1,
     -3.3698604007785281031e-2,
      3.6761360314105037449e-4

   };
   const double Q[] = {
      1,
     -3.1952146247536468518e+0,
      3.9578847517268245306e+0,
     -2.3818997058065213044e+0,
      7.1052591778287381954e-1,
     -9.4011549810642729954e-2,
      3.8243135072050931344e-3
   };
