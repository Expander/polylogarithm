 ...
 * maximum relative error of -4.14e-21.
 */
double Li2(double x) noexcept
{
   ...
   const double P[] = {
      1,
     -3.4877629806036406581e+0,
      4.8065355168304456543e+0,
     -3.3086136002716418965e+0,
      1.1793965517165813702e+0,
     -2.0187006789340150148e-1,
      1.2874560418522839331e-2,
     -1.0332187464640880695e-4
   };
   const double Q[] = {
      1,
     -3.7377629806036406554e+0,
      5.6298651508702444005e+0,
     -4.3632728901443404009e+0,
      1.8382843882211604403e+0,
     -4.0676689652237138939e-1,
      4.1240999391425611453e-2,
     -1.3083742365469852002e-3
   };
